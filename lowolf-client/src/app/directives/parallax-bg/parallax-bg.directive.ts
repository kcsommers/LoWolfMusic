import { OnInit, Directive, Renderer2, Input, HostBinding, ElementRef, HostListener, NgModule } from '@angular/core';

@Directive({
  selector: '[loParallaxBg]',
})
export class ParallaxBgDirective implements OnInit {
  private _imgUrl: string;
  private _offset = 0;
  private bgDiv: HTMLDivElement;

  @Input()
  public set loParallaxBg(src: string) {
    this._imgUrl = src;
  }
